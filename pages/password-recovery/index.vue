            ...
            <Content>
                <template #modalContent>
                    <div class="mt-20">
                        ...
                        <form class="space-y-4 md:space-y-6 mt-6" @submit.prevent="sendCode">
                            <div>
                                <label for="email" class="block mb-2 text-sm font-normal text-[#4B4B4B]">Email Address</label>
                                <input type="email" v-model="forgetEmail" name="email" id="email" class="xl:w-[382px] bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-3 py-[13px]" placeholder="Type your email address">
                            </div>
                            <button class="xl:w-[382px] w-full text-white bg-gradient-to-r from-[#0464CB] to-[#2AA1EB] font-medium rounded-lg text-[16px] px-5 py-[15px] text-center">Send Code</button>
