        ...
        <Content>
            <template #modalContent>
                <div class="mt-10">
                    ...
                    <p class="text-[18px] text-[#494949] font-normal mt-2">Need a cargo-connect account? <a href="/register" class="text-[#0464CB] font-normal text-[18px] border-b border-[#0464CB]">Register</a></p>
                    <form class="space-y-4 md:space-y-6 mt-6" action="#">
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="xl:w-[382px] bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-3 py-[13px] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type your email address" required="">
                        </div>
                        <div>
                            <label for="password" class="block mb-2 text-sm font-normal text-[#4B4B4B]">Password</label>
                            <div  class="relative">
                            <label for="createPassword" class="block mb-2 text-sm font-normal text-[#4B4B4B]">Create Password</label>

                            <svg @click="togglePassword" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="cursor-pointer w-6 h-6 absolute xl:right-3 lg:right-3 sm:right-3 right-2 top-10">
                            ...
                            <input :type="isPassword ? 'text' : 'password'" name="createPassword" id="createPassword" class="xl:w-[382px] border border-gray-300 text-gray-900 rounded-lg block w-full px-3 py-[13px]" placeholder="Type your email address" required="">
                            </div>
                        </div>
                        <div class="flex justify-end !m-0">
                            <a class="text-sm font-normal text-[#3683D5] cursor-pointer mt-2">Forgot password?</a>
                        </div>
                        <div class="flex items-center justify-between !m-0">
                            <div class="flex items-start mt-3">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="remember" class="text-[#1E1E1E] font-normal text-[14px]">Keep me Logged in</label>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="w-full text-white bg-gradient-to-r from-[#0464CB] to-[#2AA1EB] font-medium rounded-lg text-[16px] px-5 py-[15px] text-center">Login</button>
