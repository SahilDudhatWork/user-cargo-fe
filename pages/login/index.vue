            ...
            <template #modalContent>
                <div class="mt-10">
                    ...
                    <p class="text-[18px] text-[#494949] font-normal mt-2">
                        ...
                        <NuxtLink to="/register" class="text-[#0464CB] font-normal text-[18px] border-b border-[#0464CB]">Register</NuxtLink>
                    </p>
                    <form class="space-y-4 md:space-y-6 mt-6" @submit.prevent="login">
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="xl:w-[382px] border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full px-3 py-[13px] dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type your email address" v-model="formData.email" />
                        </div>
                        <div>
                            <div class="relative">
                        ...
                        <div class="flex justify-end !m-0">
                            <NuxtLink to="/password-recovery" class="text-sm font-normal text-[#3683D5] cursor-pointer mt-2">Forgot password?</NuxtLink>
                        </div>
                        ...
                        <button class="w-full text-white bg-gradient-to-r from-[#0464CB] to-[#2AA1EB] font-medium rounded-lg text-[16px] px-5 py-[15px] text-center">
                            Login
                        </button>
                        <p class="text-sm font-normal text-[#1E1E1E] max-w-[362px]">
                            By creating an account or signing you have read and agree to our
                            <span class="font-medium text-sm text-[#1E1E1E] cursor-pointer">Terms and Conditions </span>and
                            <span class="font-medium text-sm text-[#1E1E1E] cursor-pointer">Privacy Policies</span>
                        </p>
                    </form>
                </div>
            </template>
